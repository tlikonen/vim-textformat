...
function! s:Quick_Align_Right() "{{{1
...
function! s:Align_Command(align, ...) range "{{{1
	if a:align == 'left'
		if a:0 && a:1 >= 0
...
command! -nargs=? -range AlignLeft <line1>,<line2>call s:Align_Command('left',<args>)
command! -nargs=? -range AlignRight <line1>,<line2>call s:Align_Command('right',<args>)
command! -nargs=? -range AlignJustify <line1>,<line2>call s:Align_Command('justify',<args>)
command! -nargs=? -range AlignCenter <line1>,<line2>call s:Align_Command('center',<args>)

nnoremap <silent> <Plug>Quick_Align_Paragraph_Left :call <SID>Quick_Align_Left()<CR>
nnoremap <silent> <Plug>Quick_Align_Paragraph_Right :call <SID>Quick_Align_Right()<CR>
nnoremap <silent> <Plug>Quick_Align_Paragraph_Justify :call <SID>Quick_Align_Justify()<CR>
nnoremap <silent> <Plug>Quick_Align_Paragraph_Center :call <SID>Quick_Align_Center()<CR>

vnoremap <silent> <Plug>Align_Range_Left :call <SID>Align_Command('left')<CR>
vnoremap <silent> <Plug>Align_Range_Right :call <SID>Align_Command('right')<CR>
vnoremap <silent> <Plug>Align_Range_Justify :call <SID>Align_Command('justify')<CR>
vnoremap <silent> <Plug>Align_Range_Center :call <SID>Align_Command('center')<CR>
